...
async def perform_platform_action(user_message: str) -> str:
    """
    Based on the user's message, performs an action on stytch using the computer tool.
    ...
    try:
        instructions = """
            ...
            - Open chromium by starting the chromium application from the terminal.
            ...
            -  Type "John tab Doe tab Metis tab Multimodal AI Agent Hackathon".
            -  Click the "Consumer AuthenticationIntegrating auth into an application designed.
            -  Click "Next".
            -  Click "Get started".
        """
...
* To open chromium, try to run it from the terminal. 
...
async def sampling_loop(
    *,
    ...
    while True:
        ...
        # Call the API
        # Use SDK directly to create message
